...
FormatNumbers[{x_,y_}]:=(ToString[NumberForm[#1,{12,12},ExponentFunction->(Null&)]]&)/@{x,y}
...
MeshInspect[mesh_]:=mesh["Wireframe"["MeshElementStyle"->FaceForm/@ColorData[109]/@Range[CountDistinct[mesh["MeshElements"][[1,2]]]]]]//Legended[#,SwatchLegend[ColorData[109]/@Range[CountDistinct[mesh["MeshElements"][[1,2]]]],KeySort[mesh["MeshElements"][[1,2]]//Counts]//Keys]]&
